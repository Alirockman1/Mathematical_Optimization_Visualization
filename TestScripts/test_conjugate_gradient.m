...
[optimumCandidate, optimumObjectiveValue, optimizationData] = optimization_conjugate_gradient(...
    objectiveFunction, initialDesign, designSpaceLowerBound, designSpaceUpperBound, ...
    'MaxIterations', 30, 'Tolerance', 1e-10, 'LineSearchFunction', @line_search_golden_ratio, 'BetaFunction', @compute_beta_fletcher_reeves);

plot_point_optimization_results(optimizationData, 'SaveFolder',saveFolder,'SaveFigureOptions',{'Size',figureSize},...
    'LineWidth', 1, 'Color', 'b', 'Marker','o', 'LineStyle', '-', 'ShowSurfaceScatter', false);

plot_point_gradient_progress_slider(optimizationData, objectiveFunction, 'OptimizationMethod', 'Conjugate gradient', 'SaveFolder', saveFolder);
