...
[optimumCandidate, optimumObjectiveValue, optimizationData] = optimization_genetic_algorithm(...
    objectiveFunction, initialDesign, designSpaceLowerBound, designSpaceUpperBound,...
    'MaxIterations', 100, 'PopulationSize', 40, 'MutationRate', 0.08, 'CrossOverRate', 0.8);
...
plot_genetic_algorithm_progress_nd_slider(optimizationData,'SaveFolder',saveFolder);

if length(optimizationData.IterationData(1).OptimumCandidate) == 2
    plot_objective_value_progress_2d(optimizationData,'Algorithm','Genetic Algorithm','SaveFolder',saveFolder);
end
