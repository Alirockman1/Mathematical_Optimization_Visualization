...
[optimumCandidate, optimumObjectiveValue, optimizationData] = optimization_modified_newton(...
...
plot_point_gradient_progress_slider(optimizationData, objectiveFunction, 'OptimizationMethod', 'Modified Newton', 'SaveFolder',saveFolder);
