...
[optimumCandidate, optimumObjectiveValue, optimizationData] = optimization_quasi_newton(...
...
plot_point_gradient_progress_slider(optimizationData, objectiveFunction, 'OptimizationMethod', 'Quasi Newton', 'SaveFolder',saveFolder);
