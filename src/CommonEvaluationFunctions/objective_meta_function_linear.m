function objectiveValue = objective_meta_function_linear(objectiveValueBase,varargin)
%OBJECTIVE_META_FUNCTION_LINEAR Aggregate objective terms linearly from base objective evaluation.
%
%   OBJECTIVEVALUE = OBJECTIVE_META_FUNCTION_LINEAR(OBJECTIVEVALUEBASE, ...)
%   computes a scalar objective value by linearly aggregating various
...
%           1. Two-sided objectives
%           2. One-sided upper
%           3. One-sided lower
%           4. Nominal targets
%           5. Less-or-more objectives
%       The final scalar value is the row-wise sum of the selected terms.
%
%   DEPENDENCIES:
...
%   limitations under the License.
	...
	objectiveTwoSided = objectiveOneSidedLower + objectiveOneSidedUpper;
